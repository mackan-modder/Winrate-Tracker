...
- <cr>Winrate.</cr> Your winrate from 0.
- <cr>Winrate now.</cr> Your winrate from your current percentage.
- <cr>Time for 100%</cr>. The <cy>estimated time</cy> to beat the beat the level from 0.
...
- <cp>Run Rarity</cp>. Says how <cp>rare</cp> your current run is. The inverse of <cr>Winrate now.</cr>
