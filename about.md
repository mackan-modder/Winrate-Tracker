...
- <cg>Winrate.</cg> Your <cg>winrate</cg> from 0.
- <cg>Winrate now.</cg> Your <cg>winrate</cg> from your current percentage.
- <cy>Time for 100%</cy>. The <cy>estimated time</cy> to beat the beat the level from 0.
...
- <cp>Run Rarity</cp>. Says how <cp>rare</cp> your current run is. The inverse of <cg>Winrate now.</cg>
