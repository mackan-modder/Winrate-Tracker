...
bool WRMenu::init() {
    ...
    background->setContentSize({ 225.f, 111.f });
    ...
    m_buttonLink = CCMenuItemSpriteExtra::create(
        ...
        nullptr,
        this,
        menu_selector(WRMenu::onButtonLink)
    );
    m_buttonLink->setID("wr-link-button-level");
    ...
    m_buttonUnLink = CCMenuItemSpriteExtra::create(
        ...
        nullptr,
        this,
        menu_selector(WRMenu::onUnLinkCurrent)
    );
    m_buttonUnLink->setID("wr-link-button-level");
    ...
    m_buttonLinkedList = CCMenuItemSpriteExtra::create(
        ...
        nullptr,
        this,
        menu_selector(WRMenu::onLinkedList)
    );
    m_buttonLinkedList->setID("wr-link-button-level");
    ...
    m_buttonReset->setID("wr-link-button-level");
    ...
    m_buttonStats->setID("wr-link-button-level");
...
void WRMenu::onButtonLink(CCObject*) {
    if (m_isLinked) {
        unlinkPreviousPopup();
    } else {
        linkPopup();
...
void WRMenu::unlinkPreviousPopup() {
...
void WRMenu::onUnLinkCurrent(CCObject*) {
    auto alert = geode::createQuickPopup(
        "Un-Link Previous Level?",            // title
        "Do you want to un-link \"" 
...
void WRMenu::onLinkedList(CCObject*){
...
void WRMenu::unlinkLevel(std::string level) {
...
void WRMenu::linkLevel(std::string levelKeep, std::string levelDicard) {
